				...
				<div class="card-body">
					<div class="pl-0">
						...
						" :src="'https://freelancework.ir/' + localStorageService.getUser.imagePath" />
								...
								<input type="file" ref="avatar" @change="loadAvatar($event)" id="avatar"
									class="d-none" />
							</div>
							<div class="d-flex justify-content-between mg-b-20">
								<div>
					...
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
							<div class="card">
									...
									<form class="form-horizontal">
											...
											<div class="row">
												...
												<div class="col-md-9">
													<input type="text" v-model.lazy="formData.firstName"
														class="form-control" placeholder="نام کوچک" />
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="row">
												...
												<div class="col-md-9">
													<textarea class="form-control" style="resize: none"
														v-model.lazy="formData.address" rows="4"
														placeholder="نشانی"></textarea>
												</div>
											</div>
										</div>
										<div class="form-group">
											<div class="row">
												...
												<div class="col-md-9">
													<textarea class="form-control" style="resize: none"
														v-model.lazy="formData.about" rows="8"
														placeholder=""></textarea>
												</div>
											</div>
										</div>
								...
								<div class="card-footer text-center">
									<Spinner_btn v-if="loading" />
>>>>>>> 62f81d9 (fix bug token and expires token time)
