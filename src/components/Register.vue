              ...
              <div class="card-sigin">
                <div class="card-sigin">
                  <div class="card-sigin d-flex mb-5">
                    <h1 class="main-logo1 ms-1 me-0 my-auto tx-28 ps-1" style="margin-top: 20px !important">
                      درخواست عضویت
                    </h1>
                  </div>
                  <div class="card-sigin">
                    <div class="main-signup-header">
                      <form class="row" action="#">
                        <div class="form-group col-lg-6">
                          ...
                          <div style="font-size: 11px" v-if="Object.hasOwn(errors, 'firstName')" class="text-danger">
                        ...
                        <div class="form-group col-lg-6">
                          ...
                          <div style="font-size: 11px" v-if="Object.hasOwn(errors, 'lastName')" class="text-danger">
                        ...
                        <div class="form-group col-lg-6">
                          ...
                          <div style="font-size: 11px" v-if="Object.hasOwn(errors, 'phone')" class="text-danger">
                            {{ errors.phone.shift() }}
                          </div>
                        </div>
                        <div class="form-group col-lg-6">
                          ...
                          <div style="font-size: 11px" v-if="Object.hasOwn(errors, 'email')" class="text-danger">
                            {{ errors.email.shift() }}
                          </div>
                        </div>
                        <div class="form-group col-lg-6">
                          ...
                          <div style="font-size: 11px" v-if="Object.hasOwn(errors, 'codeMeli')" class="text-danger">
                        ...
                        <div class="form-group col-lg-6">
                          ...
                          <div style="font-size: 11px" v-if="Object.hasOwn(errors, 'personnelNumber')"
                            class="text-danger">
                        ...
                        <div class="form-group col-lg-6">
                          ...
                          <input class="form-control" v-model.lazy="formData.confirmPassword"
                            placeholder="تکرار رمز عبور خود را وارد کنید" type="confirmPassword" />
                          <div style="font-size: 11px" v-if="Object.hasOwn(errors, 'confirmPassword')"
                            class="text-danger">
                            {{ errors.password.shift() }}
                          </div>
                        </div>
                        ...
                        <div class="form-group col-lg-6" style="margin-top: 40px;">
                          <router-link class="btn btn-main-primary btn-block" :to="{ name: 'login' }">
